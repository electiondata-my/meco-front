...
export const DATASETS = {
  ...
  saluran_stats_jhr_se16: "https://lake.electiondata.my/results_saluran/jhr_se16_stats.parquet",
...
// Elections with saluran-level data. N9 SE-16 not available yet
...
export const DATASET_LABELS: Record<DatasetKey, string> = {
  ...
  saluran_ballots_jhr_se16: "saluran_ballots_jhr_se16",
  ...
  saluran_stats_jhr_se16: "saluran_stats_jhr_se16",
...
export const DATASET_DESCRIPTIONS: Record<DatasetKey, string> = {
  ...
  saluran_ballots_jhr_se16: SALURAN_BALLOTS_DESC,
  ...
  saluran_stats_jhr_se16:   SALURAN_STATS_DESC,
