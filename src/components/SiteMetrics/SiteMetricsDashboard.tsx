...
export default function SiteMetricsDashboard({ tbBase, token, translations }: Props) {
  ...
  const fetchData = useCallback(() => {
    const url = `${tbBase}/v0/pipes/site_metrics.json?token=${token}&date_from=${DATE_FROM}`;
