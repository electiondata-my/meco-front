...
export default {
  ...
  theme: {
    // These replace Tailwind defaults (was in preset top-level theme, not extend)
    ...
    extend: {
      ...
      colors: {
        // semantic token colors (CSS-variable backed, light/dark aware)
